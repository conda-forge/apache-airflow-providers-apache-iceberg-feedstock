About apache-airflow-providers-apache-iceberg-feedstock
=======================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/apache-airflow-providers-apache-iceberg-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/apache-airflow-providers-apache-iceberg-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add apache-airflow-providers-apache-iceberg
# for installing globally
pixi global install apache-airflow-providers-apache-iceberg
```
...
It is possible to list all of the versions of `apache-airflow-providers-apache-iceberg` available on your platform:
...
```
pixi search apache-airflow-providers-apache-iceberg --channel conda-forge
```
